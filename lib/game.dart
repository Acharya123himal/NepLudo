...
import 'package:nepludo/board/board.dart';
import 'package:provider/provider.dart';
import 'package:nepludo/board/overlay_surface.dart';
import 'package:nepludo/dice/dice_notifier.dart';
import 'package:nepludo/players/collision_details.dart';
import 'package:nepludo/players/players.dart';
import 'package:nepludo/players/players_notifier.dart';
import 'package:nepludo/result/result.dart';
import 'package:nepludo/result/result_notifier.dart';
import 'package:nepludo/util/colors.dart';
import 'dice/dice.dart';
import 'dice/dice_base.dart';

class NepLudoGame extends StatefulWidget {
  @override
  _NepLudoGameState createState() => _NepLudoGameState();
}

class _NepLudoGameState extends State<NepLudoGame>
  ...
  PlayersNotifier _playerPaintNotifier = PlayersNotifier();
  ResultNotifier _resultNotifier = ResultNotifier();
  DiceNotifier _diceNotifier = DiceNotifier();
